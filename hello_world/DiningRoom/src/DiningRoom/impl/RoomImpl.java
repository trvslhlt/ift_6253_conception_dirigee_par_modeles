 ...
 *   <li>{@link DiningRoom.impl.RoomImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RoomImpl extends MinimalEObjectImpl.Container implements Room {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiningRoomPackage.ROOM__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DiningRoomPackage.ROOM__FURNITURE:
				return getFurniture();
			case DiningRoomPackage.ROOM__NAME:
				return getName();
		}
